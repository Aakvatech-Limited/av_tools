...
from av_tools.setup.temporary_role_access import setup_temporary_role_access
...
IGNORE_TEST_RECORD_DEPENDENCIES = ["User", "Role"]


class TestTemporaryRoleAccessRequest(IntegrationTestCase):
	...
	def setUpClass(cls):
		...
		# Setup roles, workflow states, actions and the workflow
		setup_temporary_role_access()

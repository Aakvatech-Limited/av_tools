...
class ForeignImportTransaction(Document):
    ...
    def add_payment_detail(self, payment_entry):
        ...
        for existing in self.payments:
            if existing.payment_entry == payment_entry:
                return existing
    ...
    def add_lcv_detail(self, lcv_name):
        ...
        for existing in self.landed_cost_vouchers:
            if existing.landed_cost_voucher == lcv_name:
                return existing
    ...
    def recalculate_differences(self):
        ...
        from av_tools.av_tools_hooks.foreign_import import (

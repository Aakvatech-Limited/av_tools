    ...
    refresh: function(frm) {
        ...
        if (frm.doc.docstatus === 1) {
            ...
            frm.add_custom_button(__('Debug Payment Linking'), function() {
                ...
                if (payment_entry) {
                    frappe.call({
                        method: 'av_tools.av_tools_hooks.foreign_import.debug_payment_linking_issue',
                        args: {
            ...
            frm.add_custom_button(__('Link Payment Manually'), function() {
                ...
                if (payment_entry) {
                    frappe.call({
                        method: 'av_tools.av_tools_hooks.foreign_import.manually_link_payment_to_tracker',
                        args: {
                            payment_entry_name: payment_entry,

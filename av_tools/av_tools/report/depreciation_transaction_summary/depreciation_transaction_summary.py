...
def get_columns():
	return [
		{"fieldname": "asset", "label": _("Asset"), "fieldtype": "Link", "options": "Asset", "width": 120},
		{"fieldname": "asset_name", "label": _("Asset Name"), "fieldtype": "Data", "width": 120},
		{
		...
		{"fieldname": "purchase_date", "label": _("Purchase Date"), "fieldtype": "Date", "width": 100},
		{"fieldname": "opening_wdv", "label": _("Opening WDV"), "fieldtype": "Currency", "width": 120},
		{
		...
		{"fieldname": "closing_wdv", "label": _("Closing WDV"), "fieldtype": "Currency", "width": 120},
		{
...
def get_data(filters):
	...
	if filters.get("asset_category"):
		...
		assets = (
			...
			.select(Asset.name)
			.where((Asset.asset_category == filters.get("asset_category")) & (Asset.docstatus == 1))
			.run(pluck=True)
		)
	...
	for d in gl_entries:
		...
		if asset_data:
			...
			asset_data["closing_wdv"] = (
				asset_data["gross_purchase_amount"] - asset_data["total_accumulated_depreciation"]
			)

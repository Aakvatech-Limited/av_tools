...
frappe.query_reports["Salary Register Summary with Monthly Comparison"] = {
	...
	filters: [
		...
		},
		{
			...
			// "default": 1,
			on_change: function () {
				var based_on_department =
					frappe.query_report.get_filter_value("based_on_department");
		...
		},
		{
			...
			default: 0,
			on_change: function () {
				var based_on_cost_center =
					frappe.query_report.get_filter_value("based_on_cost_center");
				var cost_center = frappe.query_report.get_filter("cost_center");
				var department = frappe.query_report.get_filter("department");

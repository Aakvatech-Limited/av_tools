...
@frappe.whitelist()
def get_uom_conversion_factor(from_uom: str | None, to_uom: str | None) -> dict[str, float]:
...
@frappe.whitelist()
def make_target_from_ticket(source_name: str) -> Any:
...
@frappe.whitelist()
def read_weight(mode: str | None = None) -> dict[str, Any]:
...
def get_reference_items(
	document_type: str | None = None, document_reference: str | None = None
) -> dict[str, Any]:
...
def get_ticket_items(
	ticket: str, doctype: str | None = None, document_name: str | None = None
) -> dict[str, Any]:
	if not ticket:
...
@frappe.whitelist()
def create_weighbridge_ticket(source_name: str, source_doctype: str) -> str:
